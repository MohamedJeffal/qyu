...
module.exports = class StatusManager {
   ...
   * @param {string} statusKind - The status type (START|PAUSE)
   * @property {function} resolve - The promise 'resolve' function to call once this status is 'done'
   * @property {function} updateStatsEventInterval - Function updating the stats event interval
   ...
   * @param {number} runningJobsCount - Number of current running jobs in the consumer worker.
